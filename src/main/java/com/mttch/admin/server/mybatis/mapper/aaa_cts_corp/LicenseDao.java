...
public interface LicenseDao {
    ...
    @Select("select " +
            "id, device, cryptonumber, cryptonetwork, cryptolevel, bt_sn, name, number, cert_type, sippass, " +
            "siplogin, sipserver, is_sandbox, platform, device_token, sub, " +
            "subtime, asterisk_id, " +
            "block, lmd5, version, unixtime_block, unixtime, time_create, time_license_start, time_license_end, time_request " +
...
//            @Result(property = "singleToken", column = "single-token"),
